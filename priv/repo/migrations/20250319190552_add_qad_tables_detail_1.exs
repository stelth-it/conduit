defmodule Conduit.Repo.Migrations.AddQadTablesDetail1 do
  use Ecto.Migration
  ...
  def up do
    ...
    create table("qad_usrw_wkfl") do
      ...
      add :usrw_charfld, {:array, :string}

      add :usrw_decfld, {:array, :decimal}

      add :usrw_datefld, {:array, :naive_datetime}
      ...
      add :usrw_logfld, {:array, :boolean}

      add :usrw_intfld, {:array, :integer}
    ...
    create table("qad_tx2d_det") do
      ...
      add :tx2d__qadd01, {:array, :decimal}

      add :tx2d__qadd02, {:array, :decimal}
    ...
    create table("qad_sod_det") do
      ...
      add :sod_xslspsn, {:array, :string}

      add :sod_xcomm_pct, {:array, :decimal}
      ...
      add :sod_cum_qty, {:array, :decimal}

      add :sod_cum_date, {:array, :naive_datetime}

      add :sod_fr_rate, :decimal

      add :sod_slspsn, {:array, :string}

      add :sod_comm_pct, {:array, :decimal}

      add :sod_ord_mult, :decimal

      add :sod_pkg_code, :string

      add :sod_curr_rlse_id, {:array, :string}
      ...
      add :sod_start_eff, {:array, :naive_datetime}

      add :sod_end_eff, {:array, :naive_datetime}
      ...
      add :sod_cum_time, {:array, :integer}
    ...
    create table("qad_sadh_hist") do
      ...
      add :sadh_comment, {:array, :string}

      add :sadh_comm_pct, {:array, :decimal}
    ...
    create table("qad_sa_mstr") do
      ...
      add :sa__qadc05, {:array, :string}

      add :sa_source, :string

      add :sa_xcomm_pct, {:array, :decimal}
      ...
      add :sa_comm_pct, {:array, :decimal}

      add :sa_slspsn, {:array, :string}
    ...
    create table("qad_sypj_det") do
      ...
      add :sypj_join_crit, {:array, :string}
    ...
    create table("qad_so_mstr") do
      ...
      add :so_xslspsn, {:array, :string}

      add :so_source, :string

      add :so_xcomm_pct, {:array, :decimal}
      ...
      add :so_slspsn, {:array, :string}

      add :so_comm_pct, {:array, :decimal}
    ...
    create table("qad_sac_ctrl") do
      ...
      add :sac_trl_tax, {:array, :string}

      add :sac__qad01, :integer

      add :sac_trl_ntax, {:array, :string}
    ...
    create table("qad_tax_mstr") do
      ...
      add :tax_tax_pct, {:array, :decimal}

      add :tax_acct, {:array, :string}

      add :tax_cc, {:array, :string}
    ...
    create table("qad_sah_hist") do
      ...
      add :sah_xcomm_pct, {:array, :decimal}
      ...
      add :sah_comm_pct, {:array, :decimal}

      add :sah_slspsn, {:array, :string}
    ...
    create table("qad_sad_det") do
      ...
      add :sad_xslspsn, {:array, :string}

      add :sad_xcomm_pct, {:array, :decimal}
      ...
      add :sad_slspsn, {:array, :string}

      add :sad_comm_pct, {:array, :decimal}
    ...
    create table("qad_qod_det") do
      ...
      add :qod_xslspsn, {:array, :string}

      add :qod_comm_pct, {:array, :decimal}
    ...
    create table("qad_sv_mstr") do
      ...
      add :sv_stime, {:array, :string}

      add :sv_etime, {:array, :string}
      ...
      add :sv_mid_etime, {:array, :string}

      add :sv_mid_stime, {:array, :string}
    ...
    create table("qad_qo_mstr") do
      ...
      add :qo_xslspsn, {:array, :string}

      add :qo_source, :string

      add :qo_xcomm_pct, {:array, :decimal}
      ...
      add :qo_comm_pct, {:array, :decimal}

      add :qo_slspsn, {:array, :string}
    ...
    create table("qad_qad_wkfl") do
      ...
      add :qad_charfld, {:array, :string}

      add :qad_decfld, {:array, :decimal}

      add :qad_datefld, {:array, :naive_datetime}
      ...
      add :qad_logfld, {:array, :boolean}

      add :qad_charfld1, {:array, :string}

      add :qad_intfld, {:array, :integer}
    ...
    create table("qad_prh_hist") do
      ...
      add :prh_curr_rlse_id, {:array, :string}
    ...
    create table("qad_pod_det") do
      ...
      add :pod_cum_qty, {:array, :decimal}

      add :pod_cum_date, {:array, :naive_datetime}
      ...
      add :pod_curr_rlse_id, {:array, :string}
      ...
      add :pod_start_eff, {:array, :naive_datetime}

      add :pod_end_eff, {:array, :naive_datetime}
    ...
    create table("qad_prj_mstr") do
      ...
      add :prj_comm_pct, {:array, :decimal}
    ...
    create table("qad_pp_plan") do
      ...
      add :pp_ship_fcst, {:array, :decimal}

      add :pp_ship_act, {:array, :decimal}

      add :pp_ord_fcst, {:array, :decimal}

      add :pp_ord_act, {:array, :decimal}

      add :pp_inv_fcst, :decimal

      add :pp_inv_act, {:array, :decimal}

      add :pp_bklg_fcst, :decimal

      add :pp_bklg_act, {:array, :decimal}

      add :pp_cost_fcst, {:array, :decimal}

      add :pp_cost_act, {:array, :decimal}

      add :pp_prod_fcst, {:array, :decimal}

      add :pp_prod_act, {:array, :decimal}
    ...
    create table("qad_rqd_det") do
      ...
      add :rqd_oot_extra, {:array, :string}
    ...
    create table("qad_idh_hist") do
      ...
      add :idh_xslspsn, {:array, :string}

      add :idh_xcomm_pct, {:array, :decimal}
      ...
      add :idh_slspsn, {:array, :string}

      add :idh_comm_pct, {:array, :decimal}
      ...
      add :idh_cum_date, {:array, :naive_datetime}

      add :idh_cum_qty, {:array, :decimal}

      add :idh_curr_rlse_id, {:array, :string}
      ...
      add :idh_start_eff, {:array, :naive_datetime}

      add :idh_end_eff, {:array, :naive_datetime}
    ...
    create table("qad_isp_mstr") do
      ...
      add :isp_map_parm, {:array, :string}

      add :isp_map_parm_val, {:array, :string}
    ...
    create table("qad_grrd_det") do
      ...
      add :grrd_text, {:array, :string}

      add :grrd_calc, {:array, :string}
    ...
    create table("qad_ih_hist") do
      ...
      add :ih_xslspsn, {:array, :string}

      add :ih_source, :string

      add :ih_xcomm_pct, {:array, :decimal}
      ...
      add :ih_comm_pct, {:array, :decimal}

      add :ih_slspsn, {:array, :string}
    ...
    create table("qad_pc_mstr") do
      ...
      add :pc_min_qty, {:array, :decimal}

      add :pc_amt, {:array, :decimal}
      ...
      add :pc_max_price, {:array, :decimal}
    ...
    create table("qad_es_mstr") do
      ...
      add :es_doc_desc, {:array, :string}

      add :es_doc_exec, {:array, :string}
      ...
      add :es_doc_printed, {:array, :boolean}

      add :es_doc_printit, {:array, :boolean}

      add :es_initial_date, :naive_datetime

      add :es_doc_printer, {:array, :string}

      add :es_doc_paged, {:array, :boolean}
    ...
    create table("qad_shop_cal") do
      add :shop_wdays, {:array, :boolean}

      add :shop_hours, {:array, :decimal}
    ...
    create table("qad_tx2_mstr") do
      ...
      add :tx2__qadc01, {:array, :string}

      add :tx2__qadc02, {:array, :string}
    ...
    create table("qad_taxd_det") do
      ...
      add :taxd_taxamt, {:array, :decimal}

      add :taxd_ntaxamt, {:array, :decimal}
    ...
    create table("qad_sph_hist") do
      ...
      add :sph_sales, {:array, :decimal}

      add :sph_cost, {:array, :decimal}

      add :sph_quota, {:array, :decimal}
      ...
      add :sph__dec01, {:array, :decimal}

      add :sph__dec02, {:array, :decimal}
    ...
    create table("qad_pjd_det") do
      ...
      add :pjd_comm_pct, {:array, :decimal}
    ...
    create table("qad_esp_mstr") do
      ...
      add :esp_map_parm, {:array, :string}

      add :esp_map_parm_val, {:array, :string}
    ...
    create table("qad_shm_mstr") do
      ...
      add :shm_ship_day, {:array, :boolean}

      add :shm_rec_day, {:array, :boolean}
    ...
    create table("qad_fsp1_pln") do
      ...
      add :fsp1_bklg_act, {:array, :decimal}

      add :fsp1_bklg_fcst, {:array, :decimal}

      add :fsp1_cost_act, {:array, :decimal}

      add :fsp1_cost_fcst, {:array, :decimal}
    ...
    create table("qad_apr_mstr") do
      ...
      add :apr_map_parm, {:array, :string}

      add :apr_map_parm_val, {:array, :string}
    ...
    create table("qad_ar_mstr") do
      ...
      add :ar_xcomm_pct, {:array, :decimal}
      ...
      add :ar_comm_pct, {:array, :decimal}

      add :ar_slspsn, {:array, :string}
      ...
      add :ar_base_comm_amt, {:array, :decimal}
    ...
    create table("qad_pcc_ctrl") do
      ...
      add :pcc_pco_pre, {:array, :string}

      add :pcc_next_pco, {:array, :integer}
    ...
    create table("qad_sch_mstr") do
      ...
      add :sch_lr_asn, {:array, :string}

      add :sch_lr_date, {:array, :naive_datetime}

      add :sch_lr_qty, {:array, :decimal}

      add :sch_lr_cum_qty, {:array, :decimal}
    ...
    create table("qad_pac_mstr") do
      ...
      add :pac_amt, {:array, :decimal}

      add :pac_apr_by, {:array, :string}
    ...
    create table("qad_egc_ctrl") do
      add :egc__qadc05, {:array, :string}

      add :egc_index, :integer

      add :egc__qadc06, {:array, :string}
    ...
    create table("qad_fpc_mstr") do
      ...
      add :fpc_max_price, {:array, :decimal}

      add :fpc_min_price, :decimal

      add :fpc_min_qty, {:array, :decimal}
    ...
    create table("qad_msg_mstr") do
      ...
      add :msg_explanation, {:array, :string}
    ...
    create table("qad_knbdd_mstr") do
      ...
      add :knbdd_card_cmmt_page, {:array, :integer}
    ...
    create table("qad_fsp3_pln") do
      ...
      add :fsp3_prod_act, {:array, :decimal}

      add :fsp3_prod_fcst, {:array, :decimal}

      add :fsp3_ship_act, {:array, :decimal}

      add :fsp3_ship_fcst, {:array, :decimal}
    ...
    create table("qad_eus_mstr") do
      ...
      add :eus_etime, {:array, :string}

      add :eus_stime, {:array, :string}

      add :eus_mid_etime, {:array, :string}

      add :eus_mid_stime, {:array, :string}

      add :eus_days, {:array, :boolean}
    ...
    create table("qad_gri_mstr") do
      ...
      add :gri_ovr_code, {:array, :string}

      add :gri_ovr_type, {:array, :string}
    ...
    create table("qad_fp2_plan") do
      ...
      add :fp2_inv_act, {:array, :decimal}

      add :fp2_inv_fcst, {:array, :decimal}

      add :fp2_ord_act, {:array, :decimal}

      add :fp2_ord_fcst, {:array, :decimal}
    ...
    create table("qad_fp1_plan") do
      ...
      add :fp1_bklg_act, {:array, :decimal}

      add :fp1_bklg_fcst, {:array, :decimal}

      add :fp1_cost_act, {:array, :decimal}

      add :fp1_cost_fcst, {:array, :decimal}
    ...
    create table("qad_egd_det") do
      ...
      add :egd_days, {:array, :boolean}

      add :egd_end_time, {:array, :string}

      add :egd_end_eff, :naive_datetime

      add :egd_start_time, {:array, :string}
      ...
      add :egd_mid_etime, {:array, :string}

      add :egd_mid_stime, {:array, :string}
    ...
    create table("qad_fsp2_pln") do
      ...
      add :fsp2_inv_act, {:array, :decimal}

      add :fsp2_inv_fcst, {:array, :decimal}

      add :fsp2_ord_act, {:array, :decimal}

      add :fsp2_ord_fcst, {:array, :decimal}
    ...
    create table("qad_egw_wkfl") do
      ...
      add :egw_calls, {:array, :string}

      add :egw_tag, :boolean

      add :egw_name, :string

      add :egw_avail_hours, {:array, :string}

      add :egw_hours, {:array, :decimal}
    ...
    create table("qad_fp3_plan") do
      ...
      add :fp3_prod_act, {:array, :decimal}

      add :fp3_prod_fcst, {:array, :decimal}

      add :fp3_ship_act, {:array, :decimal}

      add :fp3_ship_fcst, {:array, :decimal}
    ...
    create table("qad_flp_plan") do
      ...
      add :flp_prod_act, {:array, :decimal}

      add :flp_prod_fcst, {:array, :decimal}
      ...
      add :flp__dec03, {:array, :decimal}

      add :flp__dec04, {:array, :decimal}
    ...
    create table("qad_dpc_mstr") do
      ...
      add :dpc_acq_pct, {:array, :decimal}

      add :dpc_rt_pct, {:array, :decimal}
    ...
    create table("qad_esh_mstr") do
      ...
      add :esh_end_time, {:array, :string}

      add :esh_start_time, {:array, :string}

      add :esh_days, {:array, :boolean}
      ...
      add :esh_mid_etime, {:array, :string}

      add :esh_mid_stime, {:array, :string}
    ...
    create table("qad_fslp_pln") do
      ...
      add :fslp_prod_fcst, {:array, :decimal}

      add :fslp_prod_act, {:array, :decimal}
      ...
      add :fslp__dec03, {:array, :decimal}

      add :fslp__dec04, {:array, :decimal}
    ...
    create table("qad_fcs_sum") do
      ...
      add :fcs_fcst_qty, {:array, :decimal}

      add :fcs_sold_qty, {:array, :decimal}

      add :fcs_pr_fcst, {:array, :decimal}

      add :fcs_abnormal, {:array, :decimal}
    ...
    create table("qad_ega_mstr") do
      ...
      add :ega_calls, {:array, :integer}

      add :ega_hours, {:array, :decimal}

      add :ega_avail_hours, {:array, :decimal}
    ...
    create table("qad_cph_hist") do
      ...
      add :cph_qty, {:array, :decimal}

      add :cph_sales, {:array, :decimal}

      add :cph_cost, {:array, :decimal}
      ...
      add :cph__dec01, {:array, :decimal}

      add :cph__dec02, {:array, :decimal}
    ...
    create table("qad_ff_mstr") do
      ...
      add :ff_his_yr, {:array, :integer}

      add :ff_orig_fc, {:array, :decimal}

      add :ff_adj_fc, {:array, :decimal}
