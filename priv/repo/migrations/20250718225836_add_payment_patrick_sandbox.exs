defmodule Conduit.Repo.Migrations.AddPaymentPatrickSandbox do
  use Ecto.Migration

  def change do
    create table("payment", prefix: "patrick_sandbox", primary_key: false) do
      ...
      add :deposit_to_account_name, :string,
        comment: "the human friendly deposit_to_account name."

      add :deposit_to_account_value, :string,
        comment: "the id of the associated deposit_to_account entry"
