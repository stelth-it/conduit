defmodule Elixir.Conduit.Sage.Object.Apterm do
  use TypedEctoSchema
  ...
  def description do
    Conduit.Sage.Objects.get_by_name_and_endpoint(1, "APTERM")
  end
  ...
  defimpl Conduit.Sage.Object.Queryable, for: __MODULE__ do
    def struct_from_api(t, params) do
      Elixir.Conduit.Sage.Object.Apterm.struct_from_api(t, params)
    end

    def description(_t) do
      Elixir.Conduit.Sage.Object.Apterm.description()
    end

    def field_list(_t, :atoms) do
      Elixir.Conduit.Sage.Object.Apterm.field_list(:atoms)
    end

    def field_list(_t, :strings) do
      Elixir.Conduit.Sage.Object.Apterm.field_list(:strings)
    end

    def field_list(_t), do: Elixir.Conduit.Sage.Object.Apterm.field_list(:strings)

    def table_name(_t), do: "APTERM"
