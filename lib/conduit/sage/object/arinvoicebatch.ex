defmodule Elixir.Conduit.Sage.Object.Arinvoicebatch do
  use TypedEctoSchema
  ...
  typed_schema "ARINVOICEBATCH" do
  ...
  def description do
    Conduit.Sage.Objects.get_by_name_and_endpoint(1, "ARINVOICEBATCH")
  end
  ...
  defimpl Conduit.Sage.Object.Queryable, for: __MODULE__ do
    def struct_from_api(t, params) do
      Elixir.Conduit.Sage.Object.Arinvoicebatch.struct_from_api(t, params)
    end

    def description(_t) do
      Elixir.Conduit.Sage.Object.Arinvoicebatch.description()
    end

    def field_list(_t, :atoms) do
      Elixir.Conduit.Sage.Object.Arinvoicebatch.field_list(:atoms)
    end

    def field_list(_t, :strings) do
      Elixir.Conduit.Sage.Object.Arinvoicebatch.field_list(:strings)
    end

    def field_list(_t), do: Elixir.Conduit.Sage.Object.Arinvoicebatch.field_list(:strings)

    def table_name(_t), do: "ARINVOICEBATCH"
