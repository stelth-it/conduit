defmodule Elixir.Conduit.Sage.Object.Apapprovalruleset do
  ...
  def description do
    Conduit.Sage.Objects.get_by_name_and_endpoint(1, "APAPPROVALRULESET")
  end
  ...
  defimpl Conduit.Sage.Object.Queryable, for: __MODULE__ do
    def struct_from_api(t, params) do
      Elixir.Conduit.Sage.Object.Apapprovalruleset.struct_from_api(t, params)
    end

    def description(_t) do
      Elixir.Conduit.Sage.Object.Apapprovalruleset.description()
    end

    def field_list(_t, :atoms) do
      Elixir.Conduit.Sage.Object.Apapprovalruleset.field_list(:atoms)
    end

    def field_list(_t, :strings) do
      Elixir.Conduit.Sage.Object.Apapprovalruleset.field_list(:strings)
    end

    def field_list(_t), do: Elixir.Conduit.Sage.Object.Apapprovalruleset.field_list(:strings)

    def table_name(_t), do: "APAPPROVALRULESET"
