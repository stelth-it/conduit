defmodule Elixir.Conduit.Sage.Object.Glcoacatmember do
  use Ecto.Schema
  import Ecto.Changeset

  @field_names "RECORDNO PARENTKEY SORTORD CATEGORYNAME WHENCREATED WHENMODIFIED CREATEDBY MODIFIEDBY RECORD_URL"
               |> String.split()

  @primary_key {:pg_id, :id, autogenerate: true}
  schema "GLCOACATMEMBER" do
  ...
  def description do
    Conduit.Sage.Objects.get_by_name_and_endpoint(1, "GLCOACATMEMBER")
  end
  ...
  defimpl Conduit.Sage.Object.Queryable, for: __MODULE__ do
    def struct_from_api(t, params) do
      Elixir.Conduit.Sage.Object.Glcoacatmember.from_api(t, params)
    end

    def description(_t) do
      Elixir.Conduit.Sage.Object.Glcoacatmember.description()
    end

    def field_list(_t, :atoms) do
      Elixir.Conduit.Sage.Object.Glcoacatmember.field_list(:atoms)
    end

    def field_list(_t, :strings) do
      Elixir.Conduit.Sage.Object.Glcoacatmember.field_list(:strings)
    end

    def field_list(_t), do: Elixir.Conduit.Sage.Object.Glcoacatmember.field_list(:strings)

    def table_name(_t), do: "GLCOACATMEMBER"
