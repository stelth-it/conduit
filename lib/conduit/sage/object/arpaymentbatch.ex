defmodule Elixir.Conduit.Sage.Object.Arpaymentbatch do
  use TypedEctoSchema
  import Ecto.Changeset

  @field_names "RECORDNO TITLE CREATED STATUS RECORDTYPE TOTAL OPEN PARENTKEY NOGL ACCOUNTNOKEY AUTOCREATED SYSTEMGENERATED WHENCREATED WHENMODIFIED CREATEDBY MODIFIEDBY CURRENCY MEGAENTITYKEY MEGAENTITYID MEGAENTITYNAME RECORD_URL"
               |> String.split()

  @primary_key {:pg_id, :id, autogenerate: true}
  typed_schema "ARPAYMENTBATCH" do
  ...
  def description do
    Conduit.Sage.Objects.get_by_name_and_endpoint(1, "ARPAYMENTBATCH")
  end
  ...
  defimpl Conduit.Sage.Object.Queryable, for: __MODULE__ do
    def struct_from_api(t, params) do
      Elixir.Conduit.Sage.Object.Arpaymentbatch.struct_from_api(t, params)
    end

    def description(_t) do
      Elixir.Conduit.Sage.Object.Arpaymentbatch.description()
    end

    def field_list(_t, :atoms) do
      Elixir.Conduit.Sage.Object.Arpaymentbatch.field_list(:atoms)
    end

    def field_list(_t, :strings) do
      Elixir.Conduit.Sage.Object.Arpaymentbatch.field_list(:strings)
    end

    def field_list(_t), do: Elixir.Conduit.Sage.Object.Arpaymentbatch.field_list(:strings)

    def table_name(_t), do: "ARPAYMENTBATCH"
