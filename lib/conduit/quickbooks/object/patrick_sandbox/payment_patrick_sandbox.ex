...
defmodule Conduit.Quickbooks.Object.PatrickSandbox.Payment do 
 ...
 @required_fields [:id, :total_amt, :customer_name, :customer_value, :sync_token, :currency_name, :currency_value, :project_name, :project_value, :private_note, :payment_method_name, :payment_method_value, :unapplied_amt, :deposit_to_account_name, :deposit_to_account_value, :exchange_rate, :line, :txn_source, :txn_date, :credit_card_payment, :transaction_location_type, :qb_updated_at, :qb_inserted_at, :payment_ref_num, :tax_exemption_name, :tax_exemption_value, :sparse]
